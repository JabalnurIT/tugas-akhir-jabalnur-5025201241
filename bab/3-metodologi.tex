...
\begin{enumerate}[topsep=0pt]
  ...
  \begin{itemize}
      ...
      Kode untuk melihat list model DistilGPT2 yang tersedia dapat dilihat pada \ref{lst:listmodel}.
      ...
      % Kode untuk setup model DistilGPT2 dapat dilihat pada \ref{lst:setupdistilgpt2}.
      ...
      Kode untuk menghapus model DistilGPT2 dapat dilihat pada \ref{lst:deletemodel}.
      ...
      Kode untuk melakukan \emph{deployment} FastAPI dapat dilihat pada \ref{lst:deploymentfastapi}.
  ...
  \begin{itemize}
      ...
      Kode untuk mengakses API FastAPI dari Scala dapat dilihat pada \ref{lst:scala-api-pseudocode}.
