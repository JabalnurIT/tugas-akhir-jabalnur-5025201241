...
% - return status 
  ...
  % - Does the summarized faulty input from FISUM retain the
  % fault detection capability?
  % - How much reduction in faulty input can FISUM provide?
  % - How long does it take to generate summarized faulty
  % inputs?
  % - How long does it take to train an application-specific
  % model by FISUM?
